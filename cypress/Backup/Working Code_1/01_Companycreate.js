describe('Create_Company and Popup Data', function() {
	...
	it('Create_Company', function() {
		cy.server()
		cy.wait(2000)
		cy.route('POST', 'https://next.pockethrms.com/Admin/Company/Index').as('companycreate')
		cy.wait(2000)
		...
		var companyText=Randomcomapnyname(2);
		var SelfservicecodeText=companycode(2);
		cy.writeFile('D:/CypressPocketHRMS/cypress/fixtures/Company.json', [{"comapnayname":companyText,"comapnaycode":SelfservicecodeText}])
	...
	it('Configuration Fields', function() {
		...
		cy.get('#labelName').type('TestField')
