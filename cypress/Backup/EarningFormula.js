...
window.addEventListener("load", function(event) {
  ...
  loadEvent = "fired";
	...
	it('Payroll Salarycompent navigate', function() {
		...
		cy.wait(2000)
		//cy.contains('h6', 'Salary Components').click({force: true})
	})
	...
	it('Add Earning Formula', function() {
		...
		if(entry.Dirper!="")
		{
		cy.get('.d-inline-block').eq(num1).click()
		cy.wait(1500)
	...
	it('Add Deduction field for CarLoan', function() {
		...
		cy.get('a[onclick="newAddDeduction()"]').click({force:true})
	...
	it('Add Deduction formula for Car Loan', function() {
		cy.get('#Salary Structure').click({force:true})
		cy.get('a[onclick="LoadFilter()"]').click({force:true})
		cy.get('#radio16').not('[disabled]').check({force: true}).should('be.checked')
		cy.get('#filterCategoryMaster').select('staff')
...
/*	describe('Add Formula for Earnings Fields ', function() {
	
	/*it('Payroll Salary structure navigate', function() {
		cy.xpath("//span[@class='menu-name'][contains(text(),'Settings')]").click({force: true})
		cy.get('#payroll_detail_tab').click({force: true})
		cy.wait(2000)
		cy.xpath("//span[@id='salaryStruct']").click({force: true})
		//cy.contains('h6', 'Salary Components').click({force: true})
		cy.wait(2000)
		cy.get('.card > .card-body > #garphEarningFormula > svg > path:nth-child(4)').click({force:true})
	})
	*/
	
	/*it('Navigate Payroll Salary Components', function() {
		cy.xpath("//span[@class='menu-name'][contains(text(),'Settings')]").click({force: true})
		cy.get('#payroll_detail_tab').click({force: true})
		cy.wait(2000)
		cy.xpath("//span[@id='salaryComp']").click({force: true})
		//cy.contains('h6', 'Salary Components').click({force: true})
		cy.wait(2000)
		//cy.get('.card > .card-body > #garphEarningFormula > svg > path:nth-child(4)').click({force:true})
	})
	...
	it('Add Earning Formula for Arrear Field Allownace', function() {
		
		cy.readFile('D:/CyPress Demo/cypress/fixtures/EmployeeProfile.json').then((text) =>{
                 text.forEach(function(entry) {
					 
					 //cy.reload()
		var field = 'Arrear Field Allownace'		 
		cy.wait(2000)	
		
		cy.get('.body-bg').each(function(row, i){			
		console.log(i)
		var num1 = parseFloat(i)
		cy.get('.preventToggle').eq(num1).invoke('text').then((text) => {
		cy.log(text.trim())
		...
		cy.contains('Earning Formula').click({force: true})		
		cy.get('#categoryMaster').select('Staff')
		cy.get('#categoryMasterNext').click({force:true})
		...
		cy.wait(5000)
		//cy.xpath("//div[@id='categoryModal']//span[contains(text(),'×')]").click({force:true})
		
		cy.get('#Dirper').select('Direct',{force:true})
		cy.wait(1000)
		cy.get('[name="Rounding"]').select('Rupee1',{force:true})
	...
	*/	
	/*it('Add Earning Formula for Arrear HRA', function() {
		cy.wait(2000)	
		cy.get('#dLabel1').click({force:true}) 
		cy.get('#E-108').click({force:true})
		cy.get('#categoryMaster').select('20',{force:true})
		cy.get('#categoryMasterNext').click({force:true})
		cy.get('#Dirper').select('Direct',{force:true})
		cy.wait(1000)
		cy.get('[name="Rounding"]').select('Rupee1',{force:true})
	...
	it('Add Earning Formula for Arrear Project Allowences', function() {
		cy.wait(2000)	
		cy.get('#dLabel1').click({force:true}) 
		cy.get('#E-119').click({force:true})
		cy.get('#categoryMaster').select('20',{force:true})
		cy.get('#categoryMasterNext').click({force:true})
		cy.get('#Dirper').select('Direct',{force:true})
		cy.wait(1000)
	...
	it('Add Earning Formula for Conditional Earning', function() {
		cy.wait(2000)	
		cy.get('#dLabel1').click({force:true}) 
		cy.get('#E-120').click({force:true})
		cy.get('#categoryMaster').select('20',{force:true})
		cy.get('#categoryMasterNext').click({force:true})
		cy.get('#Dirper').select('Conditional',{force:true})
		cy.wait(1000)
		cy.get('[name="Rounding"]').select('Rupee1',{force:true})
		cy.get('#btnForCreate').click({force:true})
	})	
	it('Add Earning Formula for Fixed HRA', function() {
		cy.wait(2000)	
		cy.get('#dLabel1').click({force:true}) 
		cy.get('#E-60').click({force:true})
		cy.get('#categoryMaster').select('20',{force:true})
		cy.get('#categoryMasterNext').click({force:true})
		cy.get('#Dirper').select('Direct',{force:true})
		cy.wait(1000)
	...
	it('Add Earning Formula for LOP credit days', function() {
		cy.wait(2000)	
		cy.get('#dLabel1').click({force:true}) 
		cy.get('#E-51').click({force:true})
		cy.get('#categoryMaster').select('20',{force:true})
		cy.get('#categoryMasterNext').click({force:true})
		cy.get('#Dirper').select('Direct',{force:true})
		cy.wait(1000)
	...
	it('Add Earning Formula for supplementory Days', function() {
		cy.wait(2000)	
		cy.get('#dLabel1').click({force:true}) 
		cy.get('#E-52').click({force:true})
		cy.get('#categoryMaster').select('20',{force:true})
		cy.get('#categoryMasterNext').click({force:true})
		cy.get('#Dirper').select('Direct',{force:true})
		cy.wait(1000)
	...
	it('Add Earning Formula for supplementory Basic', function() { // FB/MD*SD
		cy.wait(2000)	
		cy.get('#dLabel1').click({force:true}) 
		cy.get('#E-50').click({force:true})
		cy.get('#categoryMaster').select('20',{force:true})
		cy.get('#categoryMasterNext').click({force:true})
		cy.get('#Dirper').select('Direct',{force:true})
		cy.wait(1000)
	...
	it('Add Earning Formula for Earned HRA', function() { //arrear HRA  (FHRA/MD)*PD
		cy.wait(2000)	
		cy.get('#dLabel1').click({force:true}) 
		cy.get('#E-61').click({force:true})
		cy.get('#categoryMaster').select('20',{force:true})
		cy.get('#categoryMasterNext').click({force:true})
		cy.get('#Dirper').select('Direct',{force:true})
		cy.wait(1000)
	...
	it('Add Earning Formula for Master field allowences', function() { //AfIED
		cy.wait(2000)	
		cy.get('#dLabel1').click({force:true}) 
		cy.get('#E-120').click({force:true})
		cy.get('#categoryMaster').select('20',{force:true})
	...
	it('Add Earning Formula for Master Project allowences', function() { //APROJ
		cy.wait(2000)	
		cy.get('#dLabel1').click({force:true}) 
		cy.get('#E-120').click({force:true})
		cy.get('#categoryMaster').select('20',{force:true})
	...
	it('Add Earning Formula for Project allowences', function() { //(FROJ/MD)*PD
		cy.wait(2000)	
		cy.get('#dLabel1').click({force:true}) 
		cy.get('#E-120').click({force:true})
		cy.get('#categoryMaster').select('20',{force:true})
	...
	it('Add Earning Formula for Field allowences', function() { //(FFIELD/MD)*PD
		cy.wait(2000)	
		cy.get('#dLabel1').click({force:true}) 
		cy.get('#E-120').click({force:true})
		cy.get('#categoryMaster').select('20',{force:true})
		...
		it('Add Earning Formula for LOP Basic', function() { //FB/MD*LOPCD
		cy.wait(2000)	
		cy.get('#dLabel1').click({force:true}) 
		cy.get('#E-120').click({force:true})
		cy.get('#categoryMaster').select('20',{force:true})
