describe('Create_Company and Popup Data', function() {
	...
	beforeEach(function(){
      //  window.console.log('Enter the beforeEach function')
		...
		Cypress.Cookies.preserveOnce('.AspNetCore.Antiforgery.mEZFPqlrlZ8','.AspNetCore.Session','FavouriteMenus','XCategory','XCompanyId','XName','XSchemaName','XUserId','XUserName','_ga','_gat_gtag_UA_159993745_1','_gid','ai_session','ai_user','new_username','ai_user','new_username','GetLicenseData')
		cy.wait(2000)
    })
	...
	it('Create_Company', function() {
		...
		//cy.visit('https://pockethrmsnext.azurewebsites.net/Settings/Employee/Index?module=organization&submodule=companyprofile')
		//cy.wait(1000)
		cy.contains('Company Profile').click({force: true})
		cy.wait(2000)
		cy.get('#organization_tab').click({force: true})
		cy.wait(2000)
		cy.get('#Organization_CompanyProfile').click({force: true})
		cy.wait(2000)
		cy.get('[title="Add New Company"]').eq(0).click({force: true})
		cy.wait(2000)
		cy.get('#txtname').type(Randomcomapnyname(2)) 
		cy.get('#txtcompanycode').type('Cypresstest')
	...
	it('Add Category For Staff', function() {
		cy.wait(15000)
		//cy.visit('https://pockethrmsnext.azurewebsites.net/Settings/Employee/Index?module=organization&submodule=smtpsettings')
		cy.wait(1000)
	...
	it('Add Pop Up Data For ESI Location of BANGALORE', function() {
		cy.wait(1000)
		...
		cy.get('#popupvalue').type('BANGALORE')
	...
	it('Configuration Fields', function() {
		cy.wait(2000)
		cy.get('#configFields').click({force: true})
		cy.wait(3000)
