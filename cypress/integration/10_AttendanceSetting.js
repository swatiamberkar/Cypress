describe('Attendence Module ', function() {
	...
	it('Add Shift Details', function() {
		...
		cy.readFile('D:/CypressPocketHRMS/cypress/fixtures/Attendance/ShiftDetails.json').then((text) =>{
	...
	cy.wait(1000)		
	cy.readFile('D:/CypressPocketHRMS/cypress/fixtures/Attendance/Attendance_Late.json').then((text) =>{
                 text.forEach(function(entry) {	
	...
	cy.readFile('D:/CypressPocketHRMS/cypress/fixtures/Attendance/Attendance_Permission.json').then((text) =>{
                 text.forEach(function(entry) {	
   ...
   //cy.get('#chkAll').check({force: true})
	...
	cy.wait(1000)
	cy.readFile('D:/CypressPocketHRMS/cypress/fixtures/Attendance/Attendance_OT.json').then((text) =>{
                 text.forEach(function(entry) {	
	...
	cy.readFile('D:/CypressPocketHRMS/cypress/fixtures/Attendance/Attendance_CompOff.json').then((text) =>{
                 text.forEach(function(entry) {	
...
/*	it('Attendance Setting - Early Going', function() {
	...
	*/
	...
	cy.readFile('D:/CypressPocketHRMS/cypress/fixtures/Attendance/Attendance_HalfDay.json').then((text) =>{
                 text.forEach(function(entry) {	
	...
	it('Attendance Setting - Late Wise Leave', function() {
		cy.readFile('D:/CypressPocketHRMS/cypress/fixtures/Attendance/Attedance.json').then((text) =>{
                 text.forEach(function(entry) {	
