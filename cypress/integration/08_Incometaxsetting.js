describe('Income Tax Setting', function() {
	...
	it('Income Matching for Earnings fields', function() {
		...
		cy.xpath('//*[@id="incometax_detail"]/div/div[1]/div/div/div/div/ul/li[5]/label/span').click({force: true})
		cy.wait(2000);
		//click on sub menu
		...
		cy.wait(2000)
		 ...
		 cy.readFile('D:/CypressPocketHRMS/cypress/fixtures/ITAX.json').then((text) =>{
...
/*
	...
	*/
	...
	it('Add & Verify Bank Details', function() {
		...
		cy.wait(1000)
		cy.get('#txtBankName').click({force: true})
		cy.get('#txtBankName').clear()
		cy.get('#txtBankName').type(bankName)
		
		cy.get('#txtBSRCode').click({force: true})
